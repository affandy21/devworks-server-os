...
Devworks Server OS is a custom Linux system built on top of Debian Stable.

## Third-Party Software

This project may install or configure third-party components such as:

- Debian GNU/Linux packages.
- Linux kernel packages from Debian.
- systemd.
- OpenSSH.
- Nginx.
- UFW.
...
- XFCE.
- LightDM.
- Python and GTK runtime packages.
