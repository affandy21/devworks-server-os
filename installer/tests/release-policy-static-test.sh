...
grep -Fq 'Devworks Server OS Installer Wizard' "${PROJECT_DIR}/installer/devworks-installer-wizard.sh"
grep -Fq 'exec /opt/devworks/installer/devworks-installer-wizard.sh "$@"' "${PROJECT_DIR}/iso/config/includes.chroot/usr/local/sbin/devworks-installer"
grep -Fq 'exec /opt/devworks/installer/devworks-installer-wizard.sh "$@"' "${PROJECT_DIR}/iso/config/includes.chroot/usr/local/sbin/install-devworks-os"
