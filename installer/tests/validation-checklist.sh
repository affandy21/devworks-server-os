...
check "dw short command in sbin" test -L /usr/local/sbin/dw
check "devworks command in user path" test -x /usr/local/bin/devworks
check "dw short command in user path" test -x /usr/local/bin/dw
