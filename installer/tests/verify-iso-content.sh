...
grep -Fq 'Disk target:' "${ROOT}/opt/devworks/installer/devworks-installer-wizard.sh"
grep -Fq 'Service web:        nonaktif sampai user mengaktifkan' "${ROOT}/opt/devworks/installer/devworks-installer-wizard.sh"
